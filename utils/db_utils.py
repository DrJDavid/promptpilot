    ...
    try:
        ...
        if repo_id:
            ...
            if files_stored:
                ...
                analysis_stored = db.store_file_embeddings({f['metadata']['path']: embeddings[f['metadata']['path']] for f in repo_data['files'] if f['metadata']['path'] in embeddings}) # type: ignore
